...
public class BASE64Util {
    ...
    public static void main(String[] args) {
    	...
    	BASE64Util ttBase64Util =new BASE64Util();
    	String tt= ttBase64Util.encode("200 ");
    	System.out.println(ttBase64Util.encode("200 "));
    	
    	System.out.println(ttBase64Util.decode(tt));
