...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
        	...
        	<!--  <img alt="image" class="img-thumbnail" src="../img/logo.jpg" height="150" width="150"/>
            --></div>
            <div class="dropdown profile-element">
               <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                   <span class="clear">
                   <span class="text-muted text-xs block" style="text-align:center;">超级管理员<b class="caret"></b></span>
                   </span>
               </a>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <li>
                                <a class="J_menuItem" href="book/bookIndex.jsp" data-index="0">我的示例</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0" >
                    <div class="navbar-header" >
                    	<div style="float: left;vertical-align:middle;padding-left:10px;padding-top:10px;" >
		        			<img alt="image" class="img-thumbnail" src="../img/logo_jz.png" height="40" width="40" />
		        		</div>
                        <div style="font-size:30px;font-family:'MicrosoftYaHei';color:#fff;vertical-align:middle;font-weight:900;padding-top:7px;margin-left:20px;">
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" data-id="book/bookIndex.jsp">首页</a>
                    </div>
                </nav>
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="book/bookIndex.jsp" frameborder="0" data-id="book/bookIndex.jsp" seamless></iframe>
            </div>
            <div class="footer">
