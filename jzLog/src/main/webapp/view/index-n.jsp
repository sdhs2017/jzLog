...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
	 <div class="index_top" >
	 	<!-- <span style="font-size: 25px;color: #e4956d;font-weight: 600;/* margin: 5px 19px 0 0; */"></span> -->
	 	<img alt="image" src="../img/ywl.png" / width="238px">
    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu"> 
                	<li>
                        ...
                        <ul class="nav nav-second-level">
                        	<li>
                                <a class="J_menuItem" href="userManage/userManage-n.html">用户管理</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                        	<li>
                                <a class="J_menuItem" href="device/device-n.html">资产列表</a>
                            </li>
                        </ul>
                    </li>  
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                        	<li>
                                <a class="J_menuItem" href="logPro/rankingList-n.html">netflow日志</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="logPro/networkTopology-n.html">网络拓扑图</a>
                            </li>
                        </ul>
                    </li>             
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                        	<li>
                                <a class="J_menuItem" href="auditLog/auditLog-n.html">审计中心</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="auditLog/serviceManage-n.html">控制中心</a>
                            </li>
                        </ul>
                    </li>                
                </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        ...
                        <a href="javascript:;" class="active J_menuTab" data-id="logPro/rankingList-n.html">netflow日志<i class="fa fa-times-circle"></i></a>
                    </div>
                </nav>
            ...
            <div class="row J_mainContent" id="content-main">
                ...
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="logPro/rankingList-n.html" frameborder="0" data-id="logPro/rankingList-n.html" seamless></iframe>
            </div>
	...
	$.ajax({
		...
		success:function(data){
			if(data.success=="true"){
				window.location.href="../Login-n.jsp";
			}
		}
	});
}
