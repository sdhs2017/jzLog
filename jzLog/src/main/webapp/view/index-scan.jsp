...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
	 <div class="index_top" >
	 	<span style="font-size: 25px;color: #e4956d;font-weight: 600;/* margin: 5px 19px 0 0; */">      资产监控系统</span>
    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">               
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                        	<li>
                                <a class="J_menuItem" href="userManage/userManage-scan.html">用户管理</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                        	<li>
                                <a class="J_menuItem" href="device/deviceScan.html">资产配置管理</a>
                            </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        ...
                        <a href="javascript:;" class="active J_menuTab" data-id="device/deviceScan.html">资产配置管理<i class="fa fa-times-circle"></i></a>
                    </div>
                </nav>
            ...
            <div class="row J_mainContent" id="content-main">
                ...
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="device/deviceScan.html" frameborder="0" data-id="device/deviceScan.html" seamless></iframe>
            </div>
